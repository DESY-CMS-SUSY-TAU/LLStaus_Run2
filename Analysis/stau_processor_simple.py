...
class Processor(pepper.ProcessorSTau):
    ...
    def process_selection(self, selector, dsname, is_mc, filler):
        ...
        selector.set_column("jets_tight", self.jets_tight)
        # selector.set_column("pfcand_valid", partial(self.get_matched_pfCands, match_object="jets_valid", dR=0.4))
    ...
    @zero_handler
    def jets_tight(self, data):
        jets = data["jets_valid"]
        return jets[(jets.jetId >= 6)]
